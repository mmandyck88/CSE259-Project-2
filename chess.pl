...
% Predicate Drawing Pairs with Empty Slots Correlated with Letters							
...
% Pairing Letters Number Rows and Columns with Chess Pieces
pair(a,8).
pair(b,7).
pair(c,6).
pair(d,5).
